...
set CLASSPATH=%APP_HOME%\lib\Core.jar;%APP_HOME%\lib\jgrapht-core-1.5.1.jar;%APP_HOME%\lib\jheaps-0.13.jar


@rem Execute Core
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CORE_OPTS%  -classpath "%CLASSPATH%" PA5 %*
